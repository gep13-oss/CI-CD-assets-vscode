    ...
    .Does(() =>
{
        ...
        if(docFileChanged)
        {
            ...
            Wyam(new WyamSettings
            {
                ...
                OutputPath = MakeAbsolute(Directory("BuildArtifacts/Documentation")),
...
public void PublishDocumentation()
{
    if(parameters.CanUseWyam)
    {
        ...
        Kudu.Sync(MakeAbsolute(Directory("BuildArtifacts/Documentation")), publishFolder, new KuduSyncSettings {
